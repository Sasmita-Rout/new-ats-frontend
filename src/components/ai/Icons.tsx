...
export const ChatBubbleLeftRightIcon = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.722.28c-.424.032-.85-.142-1.134-.434l-3.284-3.284-3.284 3.284a.75.75 0 01-1.134.434l-3.722-.28a2.25 2.25 0 01-1.98-2.193v-4.286c0-.97.616-1.813 1.5-2.097a6.75 6.75 0 015.94-3.486c.642.023 1.253.114 1.84.265a6.75 6.75 0 015.94 3.486z" />
    </svg>
);
